...
let pth = {
    ...
    src: {
        ...
        fnts: './src/fonts/**/*.*',
        tmpl: './src/templates/',
        cssWidgets: './src/scss/widgets.scss',
    },
    wtch: {
        html: './src/**/*.html',
...
function stylesWidgets() {
    return gulp.src(pth.src.cssWidgets)
        ...
        // здесь без cleanCss и groupCssMediaQueries
...
const build = gulp.series(clear, gulp.parallel(root, html, js, jslib, styles, stylesWidgets, images, icons, fonts));
